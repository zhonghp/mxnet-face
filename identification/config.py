...
# @Last Modified time: 2017-01-11 17:21:38

ts = 0.1
epoch = 166
channel_num = 1 # set 3 when using vgg-face
face_size = 128 # set 224 when using vgg-face
gpu_id = 0 # set -1 to use cpu mode
batch_size = 1
feature_size = 256 # set 4096 when using vgg-face
exts = [".jpg", ".png"]

extractor = 'lightened_cnn' # set vgg_face when using vgg-face
